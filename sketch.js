...
function preload(){
//monsterimage = loadImage("grim.png")
}
...
function setup() {
  ...
  W = new wonderwoman(200, 200, 80, 80);
  rope = new Rope(W.body, { x: 500, y: 50 });
...
function draw() {
 ...
 Engine.update(engine);
  //monster = createSprite(2500,400)
  //monster.addImage("monsterimage",monsterimage)
  ground.display();
  box1.display();
  box2.display();
  box3.display();
